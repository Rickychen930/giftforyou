...
exports.isSameDayDelivery = isSameDayDelivery;
 ...
 */
function calculateDeliveryPrice(destinationLat, destinationLng) {
    const storeLat = store_profile_1.STORE_PROFILE.location.geo.latitude;
    const storeLng = store_profile_1.STORE_PROFILE.location.geo.longitude;
    ...
    return {
        ...
        estimatedTime,
        formattedPrice: (0, money_1.formatIDR)(price),
    };
}
/**
 ...
 */
function isSameDayDelivery(distance) {
