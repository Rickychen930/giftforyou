 ...
 */
const orderController = new (class extends BaseApiController_1.BaseApiController {
...
exports.createOrder = orderController.createOrder.bind(orderController);
exports.updateOrder = orderController.updateOrder.bind(orderController);
exports.getOrders = orderController.getOrders.bind(orderController);
exports.deleteOrder = orderController.deleteOrder.bind(orderController);
