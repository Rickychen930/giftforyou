/**
 * Store Contact Card Component (OOP)
...
/**
 * Store Contact Card Component
 * Class-based component for store contact card
 */
class StoreContactCard extends Component<StoreContactCardProps, StoreContactCardState> {
  private baseClass: string = "store-contact-card";

  private getPhoneForTel(): string {
    return String(this.props.phone ?? "").replace(/\s+/g, "");
  }

  private renderContactIcon(): React.ReactNode {
    return (
      <svg
        width="24"
        height="24"
      ...
      <StoreLocationCard icon={this.renderContactIcon()} title="Hubungi Kami" variant="contact">
        ...
        {whatsappUrl && (
          <a
            ...
            className={`${this.baseClass}__whatsapp-btn`}
