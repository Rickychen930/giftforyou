 ...
 * Trust indicators and benefits section
 */
 ...
 * Displays trust indicators and benefits
 */
class WhyChooseUsSection extends Component<{}, WhyChooseUsSectionState> {
    ...
    return [
      {
        ...
        description: "Kualitas terbaik dengan bahan pilihan untuk setiap produk",
      },
      {
        icon: (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        description: "Layanan pengiriman cepat dan tepat waktu ke seluruh Cirebon",
      },
      {
        icon: (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        description: "Tim customer service siap membantu dengan senyuman",
      },
      {
        icon: (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        description: "100% kepuasan pelanggan adalah prioritas kami",
      },
    ];
  }
  ...
  private renderBenefit(benefit: Benefit, index: number): React.ReactNode {
    ...
    return (
      ...
      >
        <div className={`${this.baseClass}__benefitIcon`}>{benefit.icon}</div>
        <h3 className={`${this.baseClass}__benefitTitle`}>{benefit.title}</h3>
  ...
  render(): React.ReactNode {
    ...
    return (
      ...
      >
        <Container variant="default" padding="lg" className={`${this.baseClass}__container`}>
          <SectionHeader
