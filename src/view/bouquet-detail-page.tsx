          ...
          <div className="bdLayoutNew">
            ...
            <div className="bdOrderSidebar">
              ...
              <div className="bdDetailsSection bdDetailsSection--sidebar">
                ...
                <div className="bdDetailsSection__body">
                  ...
                  <div className="bdDetailsSection__grid bdDetailsSection__grid--compact">
                    {Array.isArray((bouquet as any).occasions) &&
                      (bouquet as any).occasions.length > 0 && (
                        <div className="bdDetailsSection__card bdDetailsSection__card--compact">
                          ...
                          <div className="bdDetailsSection__cardContent">
                            <h3 className="bdDetailsSection__cardTitle">Acara</h3>
                            <p className="bdDetailsSection__cardDesc">{(bouquet as any).occasions.map(formatOccasion).join(", ")}</p>
                          </div>
                        </div>
                      )}
                    ...
                    {Array.isArray((bouquet as any).flowers) &&
                      (bouquet as any).flowers.length > 0 && (
                        <div className="bdDetailsSection__card bdDetailsSection__card--compact">
                          ...
                          <div className="bdDetailsSection__cardContent">
                            <h3 className="bdDetailsSection__cardTitle">Bunga</h3>
                            <p className="bdDetailsSection__cardDesc">{(bouquet as any).flowers.map(formatFlowerName).join(", ")}</p>
                          </div>
                        </div>
                      )}
                    ...
                    {bouquet.size && (
                      <div className="bdDetailsSection__card bdDetailsSection__card--compact">
                        ...
                        <div className="bdDetailsSection__cardContent">
                          <h3 className="bdDetailsSection__cardTitle">Ukuran</h3>
                          <p className="bdDetailsSection__cardDesc">{formatBouquetSize(bouquet.size)}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {bouquet.type && (
                      <div className="bdDetailsSection__card bdDetailsSection__card--compact">
                        ...
                        <div className="bdDetailsSection__cardContent">
                          <h3 className="bdDetailsSection__cardTitle">Tipe</h3>
                          <p className="bdDetailsSection__cardDesc">{formatBouquetType(bouquet.type)}</p>
                        </div>
                      </div>
                    )}
                  </div>
