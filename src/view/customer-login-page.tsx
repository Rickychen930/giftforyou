...
class CustomerLoginPage extends Component<{}, LoginState> {
  ...
  private handleGoogleLogin = async (credential: string): Promise<void> => {
        ...
        <div className="customerAuthPage__container">
          <div className="customerAuthCard">
            ...
            <div className="customerAuthCard__social">
              <button
                type="button"
                className={`customerAuthCard__socialBtn ${this.state.googleLoading ? "customerAuthCard__socialBtn--loading" : ""}`}
                onClick={() => {
                ...
                aria-busy={this.state.googleLoading}
              >
